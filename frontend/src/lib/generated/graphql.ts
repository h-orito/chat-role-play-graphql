...
export type GameRuleSetting = {
  ...
  isGameMasterViewAllMessages: Scalars['Boolean']['output'];
...
export type NewGameRuleSetting = {
  ...
  isGameMasterViewAllMessages: Scalars['Boolean']['input'];
