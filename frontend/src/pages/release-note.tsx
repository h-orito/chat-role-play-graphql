      ...
      <article className='min-h-screen w-full text-center lg:w-[960px] lg:justify-center lg:border-x lg:border-gray-300'>
        ...
        <div className='p-4'>
          ...
          <ReleaseContent label='機能拡張' date='2026/05/13'>
            ...
            <li>
              追加: ゲーム設定に「GMの発言閲覧範囲」を追加。「全て閲覧可」に
              すると GM は他参加者の独り言・秘話・自分が属していないグループの
              DM
              を含む全ての発言を閲覧できます（ゲーム概要にも表示され参加者にも分かります）
            </li>
          </ReleaseContent>
          ...
          <ReleaseContent label='性能改善' date='2026/05/12'>
            ...
            <li>
              修正:
              キャラチップを選択して参加登録した際に、通常画像のアイコンが自動でプロフィールアイコンに設定されるよう変更
            </li>
          </ReleaseContent>
